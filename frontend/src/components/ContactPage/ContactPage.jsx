...
export default function ContactPage() {
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/9113436773?text=${encodeURIComponent(text)}`;
    ...
    <div className={contactPageStyles.pageContainer}>
      ...
      <div className={contactPageStyles.gridContainer}>
        ...
        <div className={contactPageStyles.infoContainer}>
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3652.1234567890123!2d85.12345678901234!3d25.123456789012345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f1234567890123%3A0xabcdef1234567890!2sRajiv%20Nagar%2C%20Patna%2C%20Bihar%20India!5e0!3m2!1sen!2sus!4v1700000000000"
            className={contactPageStyles.map}
            title="Rajiv Nagar, Patna Location"
            loading="lazy"
            allowFullScreen
          ></iframe>
