  ...
  const socialLinks = [
    {
      ...
      name: "Facebook",
      href: "https://www.facebook.com/share/1FwAuUXXXE/",
    },
    {
      Icon: Twitter,
      color: footerStyles.twitterColor,
      name: "Twitter",
      href: "https://x.com/GoluRoyKapoor2",
    },
    {
      Icon: Instagram,
      color: footerStyles.instagramColor,
      name: "Instagram",
      href: "https://www.instagram.com/shree_golu_ray?igsh=a2x6czZ6azR2MHN0",
    },
    {
      Icon: Linkedin,
      color: footerStyles.linkedinColor,
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/priyanshu-kumar9113?utm_source=share_via&utm_content=profile&utm_medium=member_android",
    },
          ...
          <div className={footerStyles.companySection}>
            ...
            <div className={footerStyles.contactContainer}>
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>+91 9113436773</span>
              </div>
              <div className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconWrapper}>
